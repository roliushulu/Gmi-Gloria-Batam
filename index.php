<?php include'header.php';?>
	...
	<!-- Home -->
<head>
	<title>Gereja Methodist Indonesia</title>
</head>
	<div class="home">
							...
							<div class="row">
								<div class="col">
									<div class="home_content_inner">
										<div class="home_title"><h1>GEREJA GMI BATAM</h1></div>
										<div class="home_text">
											<!-- <p>GEREJA GMI MERUPAKAN GERAJA YANG MEMILIKI JEMAAT </p> -->
										</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 box_col">
					<div class="box box_emergency">
						...
						<div class="box_emergency_text">Pdt. Jenver D.Nainggolan</div>


						 <a href="https://api.whatsapp.com/send?phone=6282278773426&amp;text=Hallo%20Bapak Pendata Gereja Methodist Indonesia (GMI GLORIA), Nama : ,%20Saya%20:%20...">
                        <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-whatsapp fa-stack-1x fa-inverse"></i>
                   </span>Chat: 0822-7877-3426</a> 
                   <br>
                   	 <a href="tel:082278773426">
                        <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-phone fa-stack-1x fa-inverse"></i>
                   </span>Call : 0822-7877-3426</a> 
