...
<title>Contact GMI Gloria Batam</title>
</head>
	<div class="home">
	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<!-- Contact Info -->
				<div class="col-lg-6">
					<div class="section_title"><h2>GEREJA METHODIST INDONESIA</h2></div>
					<div class="contact_text">
						<p></p>
					</div>
					<ul class="contact_about_list">
						<li><div class="contact_about_icon"><img src="images/phone-call.svg" alt=""></div><span>+6282278773426</span></li>
						<li><div class="contact_about_icon"><img src="images/envelope.svg" alt=""></div><span>gmigloria39@yahoo.com</span></li>
						<li><div class="contact_about_icon"><img src="images/placeholder.svg" alt=""></div><span>Jl.Laksamana Bintan Bengkong Baru,Kel.Bengkong Indah - Batam</span></li>
					</ul>
				</div>
							...
							<div class="working_hours_list">
								<ul>
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div>Minggu</div>
										<div class="ml-auto">07:30 s/d Selesai</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div>Minggu</div>
