				...
				<div class="row">
					<div class="col">
						<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
							...
							<div class="top_bar_item"><a href="contanct.php">Jl.Laksamana Bintan RT 04/RW 08 Bengkong Baru-Batam</a></div>
							<!-- <div class="top_bar_item"><a href="#">Jln.Budi Kemasyarakatan No. 5 Pulo Brayan Kota, Medan</a></div> -->
							<div class="emergencies  d-flex flex-row align-items-center justify-content-start ml-auto">Admin Gereja Rolius : 0822-7877-3426</div>
						</div>
							...
							<a href="index.php">
								<div class="logo_content d-flex flex-column align-items-start justify-content-center">
									...
									<div class="logo d-flex flex-row align-items-center justify-content-center">
										<div class="logo_text">GMI GLORIA<span></span></div>
										<!-- <div class="logo_box">+</div> -->
									</div>
									<div class="logo_sub">Kec.Bengkong Indah-Batam</div>
								</div>
							</a>
						</div>
					</div>
	...
	<div class="menu_container menu_mm">
		...
		<div class="menu_inner menu_mm">
			...
			<div class="menu_extra">
				...
				<div class="menu_emergencies">HUB : 0853-7850-1710</div>
			</div>
