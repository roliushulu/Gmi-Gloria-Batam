...
<title>Contact GIKI Medan</title>
  ...
  <section id="contact" class="wow fadeInUp">
	...
	<div class="contact">
        ...
        <div class="form">
          <div id="sendmessage">Form Janji Iman ini tidak ada paksaan dari Gereja GMI Gloria</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="https://layanancoding.com/contact.php">Klik : Hub. Programmer Web GMI</a>
            </div>
            <div class="modal-footer">
