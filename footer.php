								...
								<a href="index.php" class="d-flex flex-column align-items-center justify-content-center">
									<div class="logo_content">
										<div class="logo d-flex flex-row align-items-center justify-content-center">
											<div class="logo_text">GMI<span>Batam</span></div>
											<div class="logo_box">+</div>
										</div>
										<div class="logo_sub">GEREJA METHODIST INDONESIA</div>
									</div>
								</a>
							</div>
							<div class="footer_about_text">
								<p>Mari datang beribadah di Gereja GMI Gloria Batam</p>
							</div>
							<ul class="footer_about_list">
								<li><div class="footer_about_icon"><img src="images/phone-call.svg" alt=""></div><span>+64 822-7877-3426</span></li>
								<li><div class="footer_about_icon"><img src="images/envelope.svg" alt=""></div><span>gmigloria39@yahoo.com</span></li>
								<li><div class="footer_about_icon"><img src="images/placeholder.svg" alt=""></div><span>Jl.Laksamana Bintan Bengkong Baru - Batam</span></li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="copyright_content d-flex flex-lg-row flex-column align-items-lg-center justify-content-start">
							<div class="cr"> GMI GLORIA Batam <i aria-hidden="true"></i> Dev <a href="https://layanancoding.com" target="_blank">LC: Rolius Hulu</a>
